...
text \<open>Let us now look at how to delete an edge.\<close>
...
text \<open>Let us now look at how to union two graphs.\<close>
...
text \<open>Finally, let us look at how to compute the difference of two graphs.\<close>
...
locale \<^marker>\<open>tag invisible\<close> fukakyo =
  ...
  E_inorder and
  E_inv
begin \<^marker>\<open>tag invisible\<close> 
