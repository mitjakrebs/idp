...
\isatagdocument
%
\isamarkupsection{Edmonds-Karp algorithm%
}
\isamarkuptrue%
%
\endisatagdocument
...
Let $(\isa{L},\isa{R},\isa{G})$ be a bipartite graph and \isa{M} be a matching in \isa{G}.
...
vertices in \isa{R} are connected to \isa{t}, and \isa{src} to be \isa{s}.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{definition}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
Algorithm \isa{edmonds{\isacharunderscore}{\kern0pt}karp{\isachardot}{\kern0pt}edmonds{\isacharunderscore}{\kern0pt}karp} expects an input \isa{G}, \isa{L}, \isa{R},
\isa{s}, \isa{t} such that
...
%
\begin{isamarkuptext}%
As was the case for locale \isa{alt{\isacharunderscore}{\kern0pt}bfs}, graph \isa{G} is represented as an
...
\isa{G}, \isa{L}, \isa{R}, \isa{s}, \isa{t}, \isa{M} such that
...
Let us now formally specify the assumptions on \isa{M}. As \isa{M} is the only data structure
that is subject to change from one iteration to the next, these assumptions constitute the loop
invariants of \isa{edmonds{\isacharunderscore}{\kern0pt}karp{\isachardot}{\kern0pt}loop{\isacharprime}{\kern0pt}}.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{locale}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
We now show that graph \isa{edmonds{\isacharunderscore}{\kern0pt}karp{\isachardot}{\kern0pt}G{\isadigit{1}}} comprises all edges not in the current matching.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
...
%
\begin{isamarkuptext}%
We are now able to show that \isa{edmonds{\isacharunderscore}{\kern0pt}karp{\isachardot}{\kern0pt}G{\isadigit{1}}}, \isa{edmonds{\isacharunderscore}{\kern0pt}karp{\isachardot}{\kern0pt}G{\isadigit{2}}}, \isa{s} constitutes
a valid input for algorithm \isa{alt{\isacharunderscore}{\kern0pt}bfs{\isachardot}{\kern0pt}alt{\isacharunderscore}{\kern0pt}bfs}.%
\end{isamarkuptext}\isamarkuptrue%
\isacommand{lemma}\isamarkupfalse%
